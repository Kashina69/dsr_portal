...
- No dead declarations: if a constant or variable is introduced (e.g., `ITEMS_PER_PAGE`), it must actually be wired up and used — never left as an unused constant. Confidence: 0.7
