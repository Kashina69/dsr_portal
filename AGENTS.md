...
| ----------------- | ---------------------------------------------------------------------------------------- | ---------------------------------- |
| UI Components     | [ui.components.md Quick Index](./src/components/ui/ui.components.md#L14-L43)             | small reusable components          |
| Global Components | [global.components.md Quick Index](./src/components/global/global.components.md#L14-L17) | large cross-session components     |
