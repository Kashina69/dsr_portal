...
interface SubmitterListProps {
  submitters: SubmitterInfo[];
  selectedId: string | null;
  onSelect: (submitter: Submitter) => void;
}

export function SubmitterList({ submitters, selectedId, onSelect }: SubmitterListProps) {
  return (
          ...
          return (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="truncate text-xs text-muted-foreground">{submitter.department}</p>
              </div>
              {pendingCount > 0 && (
